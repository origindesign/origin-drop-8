(function ajaxViewLoadingScript ($, Drupal) {

    Drupal.behaviors.ajaxViewLoading = {};
    Drupal.behaviors.ajaxViewLoading.xhr = null; // ajax call
    Drupal.behaviors.ajaxViewLoading.ajaxContainer = '';
    Drupal.behaviors.ajaxViewLoading.ajaxPath = '';
    Drupal.behaviors.ajaxViewLoading.params = '';
    Drupal.behaviors.ajaxViewLoading.urlParams = '';
    Drupal.behaviors.ajaxViewLoading.filterForm = $('.filterform');
    Drupal.behaviors.ajaxViewLoading.categories = $(".filterform .categories");

    Drupal.behaviors.ajaxViewLoading.attach = function (context) {

        let _obj = Drupal.behaviors.ajaxViewLoading;

        $('.ajax-list-container', context).once('ajaxViewLoading').each(function () {
    ...
    Drupal.behaviors.ajaxViewLoading.updateParamsFromHash = function (){
    ...
    Drupal.behaviors.ajaxViewLoading.updateFilters = function (params){
    ...
    Drupal.behaviors.ajaxViewLoading.createUrlParams = function ($params){
    ...
    Drupal.behaviors.ajaxViewLoading.displayList = function ($container, $path, $params){
