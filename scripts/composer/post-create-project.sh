...
docker-compose run -w /var/www/html/web php drush pm-enable page --yes --strict=0
docker-compose run -w /var/www/html/web php drush pm-enable activity article event lesson banner lift_trail lodging dining --yes --strict=0
